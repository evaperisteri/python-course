...
# result: the addition of the 1st and the last digit -> 1 + 8 =9
first_num = int(number_str[0])
last_num = int(number_str[-1])
result = first_num + last_num
print()
print(result)
#or in just one line
print(f"Result = {int(number_str[0]) + int(number_str[-1])}")